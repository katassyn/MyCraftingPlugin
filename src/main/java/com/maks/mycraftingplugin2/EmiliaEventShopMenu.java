...
/**
 * Event Shop submenu for Emilia with tier access controls.
 */
public class EmiliaEventShopMenu {

    public static void open(Player player) {
        Inventory inv = Bukkit.createInventory(null, 27, "Emilia - Event Shop");
    ...
    public static void openEditor(Player player) {
        Inventory inv = Bukkit.createInventory(null, 27, "Edit Emilia - Event Shop");
