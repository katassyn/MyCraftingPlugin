...
/**
 * Event Shop submenu for Gnob with tier access controls.
 */
public class GnobEventShopMenu {

    public static void open(Player player) {
        Inventory inv = Bukkit.createInventory(null, 27, "Gnob - Event Shop");
    ...
    public static void openEditor(Player player) {
        Inventory inv = Bukkit.createInventory(null, 27, "Edit Gnob - Event Shop");
